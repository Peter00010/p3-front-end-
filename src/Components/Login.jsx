...
<h2 className="text-2xl font-extrabold mt-2 text-center py-3" style={{color:"#FFFFFF"}}>Please Login</h2>
...
<form onSubmit={handleSubmit} className="w-full max-w-md  px-4">
            ...
            <div className="mt-6">
              ...
              <Link to="/"><button
              style={{backgroundColor:"#3A55EB",color:"#FFFFFF"}} className="w-full px-6 py-3 rounded-lg">
                Sign in
              </button></Link>
